...
class UserControllerTest {
	...
	void initData() {
		...
		request = UserCreationRequest.builder().username("taisu").firstName("Taisu").lastName("anhhao")
				.password("12345678").dob(dob).build();

		userResponse = UserResponse.builder().id("cf0600f538b3").username("taisu").firstName("Taisu").lastName("anhhao")
				.dob(dob).build();
	}
